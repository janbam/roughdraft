...
The Markdown file is the normative storage format. For APIs, tests, and integrations, implementations MAY expose a review index JSON document that follows [`roughdraft-flavored-markdown.schema.json`](https://www.roughdraft.md/spec/roughdraft-flavored-markdown.schema.json).
...
Conformance fixtures live in [`fixtures/`](https://www.roughdraft.md/spec/fixtures/). A parser that claims Roughdraft Flavored Markdown 0.1 support SHOULD pass those examples or document any intentional differences.
